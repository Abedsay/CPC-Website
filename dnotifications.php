...
<body>
    <aside class="sidebar">
        ...
        <nav class="navigation">
            ...
            <a href="dnotifications.php" class="active"><i class="fas fa-envelope"></i>&nbsp; Notifications</a>
        ...
        <div class="messaging-container">
            <aside class="contact-list">
                ...
                <div class="contact" data-doctor-id="doctor1">
                    <img src="images/manAvatar.png" alt="Dr. Lionel Messie">
            ...
            <section class="chat-area">
                <header class="chat-header">
                    <img src="images/manAvatar.png" alt="Dr. Lionel Messie" class="chat-avatar">
                    <div class="chat-info">
