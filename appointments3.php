        ...
        <div class="doctor-list">
            ...
            <div class="doctor-card">
                ...
                <div class="doctor-details">
                    <p class="doctor-specialization">Dentistry</p>
                    <h2 class="doctor-name">Dr. Adam Smith</h2>
                    <p class="doctor-location">Dubai, UAE</p>
                    <span class="price-range">Price $300 - $2500</span>
                </div>
                <a href="test2.php?doctor_id=<?php echo $doctor_id; ?>"><button class="check-availability">Check Availability</button></a>
            </div>
            <div class="doctor-card">
                <img src="assets/dr1.webp" alt="Doctor Lionel Messie" class="doctor-photo">
                <div class="doctor-details">
