    ...
    <div class="main-content">
        ...
        <div class="clinic-list">
            ...
            <div class="clinic-card">
                ...
                <a href="mappointments1.php"><button class="check-availability">View Doctor</button></a>
            </div>
            ...
            <div class="clinic-card">
                ...
                <a href="mappointments2.php"><button class="check-availability">View Doctor</button></a>
            </div>
            ...
            <div class="clinic-card">
                ...
                <a href="mappointments3.php"><button class="check-availability">View Doctor</button></a>
            </div>
            ...
            <div class="clinic-card">
                ...
                <a href="mappointments4.php"><button class="check-availability">View Doctor</button></a>
            </div>
            ...
            <div class="clinic-card">
                ...
                <a href="mappointments5.php"><button class="check-availability">View Doctor</button></a>
            </div>
